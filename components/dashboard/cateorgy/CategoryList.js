...
const CategoryLi = ({ cat, type }) => {
  ...
  px-[18px] py-3 relative overflow-hidden hover:transform"
    >
      <div className="fliped absolute w-full h-full z-10 bg-black/50 top-0 right-0 flex items-center justify-center">
      ...
      <h3 className="job-title font-bold text-[18px] text-[#333333]">{trimText(cat.title, 30)}</h3>
