      ...
      {formSend ? (
        ...
        <PopUp defaultOpen>
          <div className="flex flex-col items-center justify-center py-4 px-10">
            <h2 className="text-center text-3xl font-bold text-gray-mid">
              נשארתם עם שאלה לא פתורה?
            </h2>
            <h2 className="text-center text-3xl font-medium text-gray-mid">
            ...
            <div>
              <form method="POST" onSubmit={handleSubmit}>
                <div className="text-gray-mid text-center text-[25px] font-bold my-[25px]">
