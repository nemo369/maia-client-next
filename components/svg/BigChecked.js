function BigChecked() {
  return (
    ...
    >
      <defs>
        <circle id="BigChcked-path-1" cx="30.492" cy="30.492" r="30.492" />
        <filter
          id="BigChcked-filter-2"
          width="109.8%"
          height="109.8%"
          x="-4.9%"
          y="-4.9%"
      ...
      <g fill="none" fillRule="evenodd" stroke="none" strokeWidth="1">
        <g transform="translate(-578 -3471)">
          <g transform="translate(578 3471)">
            <g>
              <use fill="#39DC8E" xlinkHref="#BigChcked-path-1" />
              <use fill="#000" filter="url(#BigChcked-filter-2)" xlinkHref="#BigChcked-path-1" />
              <circle
                cx="30.492"
                cy="30.492"
                r="28.98"
            ...
            <g filter="url(#BigChcked-filter-3)">
              <g transform="translate(13.356 18.144)">
                <mask id="BigChcked-mask-5" fill="#fff">
                  <use xlinkHref="#BigChcked-path-4" />
                </mask>
                <use fill="#000" fillRule="nonzero" xlinkHref="#BigChcked-path-4" />
                <g fill="#000" mask="url(#BigChcked-mask-5)">
