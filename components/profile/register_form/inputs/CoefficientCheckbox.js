const CoefficientCheckbox = (props) => {
  ...
  return (
    <div className="signup-frist-checkbox-wrapper flex items-center">
      ...
      <div className="relative smallpop w-4 h-4 border-solid rounded-full font-small bg-gray text-white text-xs mr-4 hover:bg-gradient-2 inline-block text-center">
        ?
        <div className="top-4 left-0  text-right text-black coeffitiontPop absolute h-48 w-96 bg-white  mr-96 rounded-lg text-sm px-6 py-4 overflow-auto  z-40">
          <p>
            מקדם התעבוקה ילווה אותך בתהליכי קבלת ההחלטות לבניית מסלון אישי לקרייה שלך ללא עלות. אך
            אל דאגה! לא תהיה לנו גישה אל הפרטים שלכם ללא אישור מפורט ממכם!
          </p>
