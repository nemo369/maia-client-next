  ...
  return (
    <div>
      ...
      <h2 className="max-w-4xl my-5">
        {t(
          ' כאן תוכלו לקרוא על מסלולי לימוד שיכולים להתאים לכם או שמעניין אתכם לקרוא עליהם. מאיה מציגה בפניכם את מסלולי הלימוד המתאימים ביותר. השתמשו במסננים לקריאה על מסלולים נוספים.'
        )}
      </h2>
    </div>
  );
